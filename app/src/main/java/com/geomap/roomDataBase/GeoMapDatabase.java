...
@Database(entities = {UnderGroundMappingReport.class, OpenCastMappingReport.class, AttributeData.class, Nos.class, SampleCollected.class, WeatheringData.class, RockStrength.class, WaterCondition.class, TypeOfGeologicalStructures.class, TypeOfFaults.class, Geologist.class}, version = 1, exportSchema = false)
