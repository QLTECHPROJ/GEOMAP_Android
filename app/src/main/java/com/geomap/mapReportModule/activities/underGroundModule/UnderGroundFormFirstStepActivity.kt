...
class UnderGroundFormFirstStepActivity : AppCompatActivity() {
        ...
        binding.cvAttributes.setOnClickListener {
            ...
            if (attributeModelList.isEmpty()) {
                ...
                attributesAdapter = AttributesAdapter(
                    dialog, binding, attributeModelList, rvList,
                    tvFound, ctx
                )
    ...
    private fun clearData(flag : String) {
        ...
        if (flag == "0") {
            if (attributeDataModelList.isEmpty()) {
                ...
                callUnderGroundFormSecondStepActivity(
                    act, "1",
    ...
    class AttributesAdapter(
            ...
            var ctx : Context
    ) : RecyclerView.Adapter<AttributesAdapter.MyViewHolder>(), Filterable {
    ...
    class NosAdapter(
            ...
            private var rvList : RecyclerView, private var tvFound : TextView,
            var ctx : Context
    ) : RecyclerView.Adapter<NosAdapter.MyViewHolder>(), Filterable {
